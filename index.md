...
<head>
<!--     <script src="temp.js" integrity="sha256-BbhdlvQf/xTY9gja0Dq3HiwQF8LaCRTXxZKRutelT44=" crossorigin="anonymous"></script>
    <link href="temp.css" rel="stylesheet" /> -->
    <title>Designs by @</title>
</head>
...
<body onload="draw()">
    ...
    <main id="content">
        <h1>
            <div class="hex moved"></div><span>About me</span></h1>
...
<!--         <div class="subtext coll">
        ...
        <div class="subtext coll">
            <ul>
                <li>Phone: +  0 1 2 3 4 5</li>
                <li>E-mail: <a>myemai@gmal.com</a></li>
                <li>LinkedIn: <a>Huytran#0371</a></li>
            </ul>
        </div>
<!--     </main>
